#fonction pour cree un mot de passe
def signup
...
#fonction checking mot de passe ulitisateur 
def login(mdp)
...
#fonction pour afficher un message de bienvenu si l'authentification est avec success
def welcome_screen
